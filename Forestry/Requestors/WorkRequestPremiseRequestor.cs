...
{
    public class WorkRequestPremiseRequestorSetting : BaseRequestorSettings
    {
        public static WorkRequestPremiseRequestorSetting Get()
        {
            return new WorkRequestPremiseRequestorSetting()
            {
    ...
    public class WorkRequestPremiseRequestor : BaseRequestor, IResourse<List<Forestry.Models.DTO.Premise>>
    {
        public WorkRequestPremiseRequestor(IHttpClient client, WorkRequestPremiseRequestorSetting setting)
        ...
        public List<Forestry.Models.DTO.Premise> Get(Uri uri)
        {
            return base.Get<List<Forestry.Models.DTO.Premise>>(uri);
        }
